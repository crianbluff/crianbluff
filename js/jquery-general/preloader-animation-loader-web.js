$(document).ready(function() {
  ...
  setTimeout(function() {
    ...
    if ($('#ctn-preloader').hasClass('loaded')) {
      ...
      // Frase sección bienevenida web inicio, footer-pc web general
      $('.col-animation-bounceinright, #footer-pc').addClass('bounceinright');
      ...
      // Iconos columnas inicio, lenguajes, frameworks, cms y herramientas de desarrollo, imágenes lenguajes, frameowrks, cms herramientas de desarrollo quiénes somos web quiénes somos
      $('#ctn-icon-col-service, .ctn-icon-col-about-us, .ctn-img-development').addClass('gelatine');
