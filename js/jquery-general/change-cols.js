$(document).ready(function() {
	...
	$('.ctn-icon-col-plus').on('click', function() {
		$(this).siblings('.container').find('.col-4').hasClass('col-4') ? $(this).siblings('.container').find('.col-4').removeClass('col-4 col-md-4 col-sm-4 col-xs-4').addClass('col-12 col-md-12 col-sm-12 col-xs-12') : '';
		$(this).siblings('.container').find('.col-2').hasClass('col-2') ? $(this).siblings('.container').find('.col-2').removeClass('col-2 col-md-2 col-sm-2 col-xs-2').addClass('col-4 col-md-4 col-sm-4 col-xs-4') : '';
	});

	$('.ctn-icon-col-minus').on('click', function() {
		$(this).siblings('.container').find('.col-4').hasClass('col-4') ? $(this).siblings('.container').find('.col-4').removeClass('col-4 col-md-4 col-sm-4 col-xs-4').addClass('col-2 col-md-2 col-sm-2 col-xs-2') : '';
		$(this).siblings('.container').find('.col-12').hasClass('col-12') ? $(this).siblings('.container').find('.col-12').removeClass('col-12 col-md-12 col-sm-12 col-xs-12').addClass('col-4 col-md-4 col-sm-4 col-xs-4') : '';
	});
